...
PROFESSIONS = [
	...
	'Cleaner', 'Cameraman', 'Captain', 'Caption Writer', 'Cargo Agent', 'Carpenter', 'Cartographer', 'Cartoonist', 'Cashier', 'Ceiling Tile Installer', 'Chef', 'Cook', 'Chemical Engineer', 'Chemist', 'Chemistry Teacher', 'CEO', 'CTO', 'COO', 'CFO', 'Creative Director', 'Child Care Worker', 'Chiropractor', 'Choreographer', 'City Planner', 'Civil Engineer', 'Claims Adjuster', 'Car Wash Operator', 'Clergyman', 'Cardinal', 'Coach', 'Community Manager', 'Compliance Officer', 'Composer', 'Customer Support', 'Call Center Agent', 'Concierge', 'Construction Worker', 'Copy Writer', 'Coroner', 'Correctional Officer', 'Cost Estimator', 'Costume Designer', 'Counselor', 'Courier', 'Court Clerk', 'Court Reporter', 'Craftsman', 'Creative Writer', 'Credit Analyst', 'Critical Care Nurse', 'Curator', 'Customs Inspector', 'Cricket Player', 'Chip Designer', 'Cowboy', 'Conman', 'Cosmetologist', 'Composer', 'Chauffeur', 
	...
	'Researcher', 'Representative', 'Race Driver', 'Recruiter', 'Radio Mechanic', 'Radiologist', 'Railroad Inspector', 'Real Estate Broker', 'Receptionist', 'Recycling Coordinator', 'Reporter', 'Retail Saleman', 'Rigger', 'Roofer', 
